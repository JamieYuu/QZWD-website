        ...
        <div id="indexbody">
            ...
            <div id="headerImgPart">
                ...
                <div id="aboutUsTextDiv">
                    <p id="aboutUsText">仲裁</p>
                </div>
            </div>

            <br/>
            <div id="suoying">
                <p><router-link to="/allBusiness">业务领域 </router-link> <i class="fa fa-angle-right" aria-hidden="true"></i> 仲裁</p>
            </div>
            <hr id="hr1">
...
export default {
  data () {
    return {
      ...
      headerImg: require('@/assets/ABTImg.jpg'),
